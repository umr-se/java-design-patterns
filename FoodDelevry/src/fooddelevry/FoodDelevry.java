...
class FoodDelevryGUI extends JFrame 
{	
	private JRadioButton res, par;	
	private ButtonGroup group;
	private JLabel logo_name, delivery_type, date_time, table_no, name, address, contact ,email, toppings_label, quantity_label;
	private ImageIcon logo;
	private JTextField table_no_tf, name_tf, address_tf, contact_tf, email_tf;
	...
	private JLabel table_no_op, name_op, address_op, contact_op, email_op;
	String table_no_str, name_str, address_str, contact_str, email_str;
	private JLabel table_no2, name2, address2, contact2;
	private JLabel date_time2;
	private JLabel logo_name2;
	
	
	public FoodDelevryGUI() 
	{
		super("JAVA GUI");
		setLayout(new FlowLayout(FlowLayout.CENTER, 30, 15));
		logo = new ImageIcon("gui.png");			
		logo_name = new JLabel("JAVA GUI", logo, 0);
		initial_panel = new JPanel();
		initial_panel.setLayout(new GridLayout(2, 1));		
		
		JOptionPane.showMessageDialog(new JFrame(), "Welcome to JAVA GUI!!!", "JAVA GUI", JOptionPane.PLAIN_MESSAGE, logo);
	...
	{		
		...
		//Delivery Type
		delivery_type = new JLabel("Delievery Type:");
	        delivery_panel.add(delivery_type);		
		res = new JRadioButton("At Postcode");
		res.setActionCommand("res");
		par = new JRadioButton("At this place");
	...
	public void Toppings()
	{
		...
		top_onion = new JCheckBox("Margherita", false);
		top_mushroom = new JCheckBox("Small", false);
		top_broccoli = new JCheckBox("Mushrooms", false);
		top_corn = new JCheckBox("Four Seasons", false);
		top_capsicum = new JCheckBox("Medium", false);
		top_cheese = new JCheckBox("Green peppers", false);
	...
	{
		quantity_label = new JLabel("Delievery instructions");
		quantity_op_label = new JLabel("Delievery instructions");
		quantity_op = new JLabel();
		quantity_panel = new JPanel();
		quantity_panel.setLayout(new GridLayout(2, 2));
		String[] quantity = {"Hurry up , I'm hungry","Please on time"};
	...
	{	
		...
		table_no2 = new JLabel("Postcode: ");
		name2 = new JLabel("Name: ");
		address2 = new JLabel("Address: ");
		contact2= new JLabel("Tel: ");
		...
		print = new JButton("Submit Order");
...
//		buttons_panel.add(clear);		
		...
		print.addActionListener(new ActionListener()
		{
			...
			{	
				...
				logo_name2 = new JLabel("JAVA GUI", logo, 0);		
...
public class FoodDelevry {
    
    public static void main(String[] args) {
        
                FoodDelevryGUI gui_obj = new FoodDelevryGUI();	
		gui_obj.Input();		
		gui_obj.Toppings();
		gui_obj.Quantity();			
		gui_obj.Output();	
